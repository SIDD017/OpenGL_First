...
int main()
{
	...
	//Window creation
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "First OpenGL Project", NULL, NULL);
	if (window == NULL)
	{
	...
	//set mouse as input and disable onscreen mouse visibility
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Sets perspective projection and zooming parameters
